...
<body>
	<div class="container-xxl bg-white p-0">
			...
			<nav
				...
				<a href="#" class="navbar-brand p-0">
					<h1 class="text-primary m-0">
						<i class="fa fa-utensils me-3"></i>Masala Nama
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<div class="navbar-nav ms-auto py-0 pe-4">
						<a href="/" class="nav-item nav-link active">Home</a> <a href="#"
							...
							class="nav-item nav-link">Menu</a>
					...
					<div class="row align-items-center g-5">
						<div class="col-lg-6 text-center text-lg-start">
							<h1 class="display-3 text-white animated slideInLeft">
								Every Flavour<br>Tells A Story
							</h1>
							<p class="text-white animated slideInLeft mb-4 pb-2">Fine
								Indian Cuisine</p>
							<a href="#"
				...
				<div class="row g-5 align-items-center">
					...
					<div class="col-lg-6">
						<h5
							...
							Us</h5>
						<h1 class="mb-4">
							Welcome to <i class="fa fa-utensils text-primary me-2"></i>Masala
							Nama
						</h1>
						<p class="mb-4">########</p>
						<p class="mb-4">########</p>
		...
		<script>
			function myMap() {
				var mapProp = {
					center : new google.maps.LatLng(26.47594081171191,
							74.63546332609347),
					zoom : 19,
				};
		...
		<!-- Correct URL -->
		<!-- <script
			src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDtWFHRwlqCDXeGGF0SpYy-bAkxvLtoMeA&callback=myMap"></script> -->
		<script
			src="https://maps.googleapis.com/maps/api/js?key=Try&callback=myMap"></script>
		<!-- Google Maps API End -->
			...
			<div class="container py-5">
				<div class="row g-5">
					...
					<div class="col-lg-3 col-md-6">
						...
						<p class="mb-2">
							<i class="fa fa-map-marker-alt me-3"></i>SHOP# 2, Ashok Nagar,
							Ana Sagar Link Rd, adjacent to CITY HOSPITAL, Mali Mohalla,
					...
					<div class="row">
						<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="https://htmlcodex.com">HTML
								Codex</a> -->
							<br> <br> Designed By <a class="border-bottom" href="#">Balvinder
								Singh</a>
						</div>
